...
<div class="max-w-3xl bg-white rounded-xl shadow p-8">
    <h2 class="text-2xl font-semibold mb-6">Add New Grade</h2>
    ...
    <form action="{{ route('grades.store') }}" method="POST">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="score" value="{{ old('score') }}" class="w-full rounded border-gray-300 p-3" required>
            </div>
        </div>

        <div class="mt-6 flex gap-3">
            <button type="submit" class="px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Save Grade</button>
